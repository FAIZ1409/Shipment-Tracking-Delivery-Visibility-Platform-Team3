...
type AdminAnalytics = {
  ...
  routePerformance: {
    ...
    timeEstimateAccuracyPercent: number | null;
    bestPerformingRoutes: RoutePerformanceItem[];
    worstPerformingRoutes: RoutePerformanceItem[];
  };
  systemMonitoring: {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        {data && (
          <div className="space-y-6">
              ...
              <SectionCard title="Route Performance">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <StatCard
                    ...
                    value={
                      data.routePerformance.timeEstimateAccuracyPercent != null
                        ? `${data.routePerformance.timeEstimateAccuracyPercent.toFixed(0)}%`
                        : "—"
                    }
                  />
                </div>
            ...
            <SectionCard title="Route Analytics">
              <div className="grid gap-6 lg:grid-cols-2">
                <RoutePerformanceTable
                  title="Best Performing Routes"
                  routes={data.routePerformance.bestPerformingRoutes}
                  accent="text-emerald-700"
                />
                <RoutePerformanceTable
                  title="Worst Performing Routes"
                  routes={data.routePerformance.worstPerformingRoutes}
                  accent="text-red-700"
                />
              </div>
            </SectionCard>
...
function RoutePerformanceTable({
  title,
  routes,
  accent,
}: {
