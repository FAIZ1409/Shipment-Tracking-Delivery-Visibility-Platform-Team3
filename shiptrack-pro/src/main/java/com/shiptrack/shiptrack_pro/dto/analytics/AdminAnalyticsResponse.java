...
public class AdminAnalyticsResponse {
    ...
    public static class RoutePerformance {
        ...
        // % how close actual time tracked to estimated time, averaged
        // across routes that have both figures recorded (100 = perfect).
        private Double averageDelayMinutes;
        private Double timeEstimateAccuracyPercent;
        private List<RoutePerformanceItem> bestPerformingRoutes;
        private List<RoutePerformanceItem> worstPerformingRoutes;

        @Data
        @Builder
        @NoArgsConstructor
        @AllArgsConstructor
        public static class RoutePerformanceItem {
